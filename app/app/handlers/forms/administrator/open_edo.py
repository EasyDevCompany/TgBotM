...
def register(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(get_staff_role, state=OpenAcs.staff_role)
    ...
    dp.register_callback_query_handler(get_staff_role_edit, state=OpenAcs.staff_role_edit)
