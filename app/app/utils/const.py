...
HASE_NOT_PERMISSION = "У вас нет прав для совершения этих действий"
...
LOAD_DOC = 'Пожалуйста, загрузите документ или фото документа'
...
NEW_BID = 'Поступила новая заявка'

USER_EDIT_TICKET = 'Пользователь отредактировал заявку'