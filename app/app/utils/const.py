...
EDIT_SHIP = 'Для внесения корректировок в поставку в форме необходимо:\n\n' \
            '4) Прикрепить служебную записку, написанную на имя своего ' \
            'руководителя по шаблону, подписанную Вами и руководителем.\n' \
            '5) Указать номер заявки\n6) Указать номер накладного документа' \
            '\n7) Указать входящий склад\n8) Указать, что необходимо ' \
            'отредактировать в поставке\n9) Подробно описать ошибку в ' \
            'поставке\n10) Прикрепить дополнительные файлы (по необходимости)' \
            '\n\nшаблон'
...
ADJ_INVOICE = 'Для корректировки оформленной накладной необходимо:\n' \
              '4) Прикрепить подписанную служебную записку, в которой ' \
              'указана причина корректировки\n\n5) Указать номер ' \
              'накладной, в которой необходимо внести корректировки\n\n' \
              '6) Указать номер заявки, к которой принадлежит накладная\n\n' \
              '7) Выбрать, что необходимо отредактировать в накладной\n\n' \
              '8) Указать уточняющие данные\n\n шаблон'
